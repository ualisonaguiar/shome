  ...
  if("editdiv"==k)m=[this._element];
    ...
    for(g=0;g<e.length;g++){
      ...
      for(b=0;b<e[g].length;b++){
        ...
        for(b=0;b<e[g].length;b++)if(f=e[g][b],!f.getCustomData||!f.getCustomData("block_processed"))f.is&&CKEDITOR.dom.element.setMarker(c,f,"block_processed",!0),b||j.insertBefore(f),j.append(f);CKEDITOR.dom.element.clearAllMarkers(c);
      d.push(j)
      }
      i.selectBookmarks(l);
    m=d
